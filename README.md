# Задача прогнозирования лесного покрова
...
1. <a href="#g10">Один полный пример запуска из коммандной строки</a>
...
14. <a href="#g14">Проверка всего подготовленного пакета вызовом одной команды</a>
15. <a href="#g15">Элементы CI/CD с использованием функционала github</a>

***
<h2 id="g0">Раздел для пользователя</h2>

<h3 id="g1">1. Общее описание задачи</h3>
...
***
<h3 id="g3">3. Установка пакета, получение данных, использование Poetry</h3>
...
***
<h3 id="g4">4. Реализация командной строки</h3>
...
***
<h3 id="g5">5. Сведения об использованных моделях машинного обучения</h3>
...
***
<h3 id="g6">6. Сведения о реализованных подходах подбора и генерации признаков (feature selection)</h3>
...
***
<h3 id="g7">7. Метрики, использованные для оценки моделей</h3>
...
***
<h3 id="g8">8. Применение MLFlow для сохранения результатов работы пакета</h3>
...
***
<h3 id="g9">9. Обычный и nested варианты Cross-validation и подбор гиперпараметров</h3>
...
<h3 id="g11">11. Реализованные тесты</h3>
...
***
<h3 id="g12">12. Форматирование кода в проекте</h3>
...
***
<h3 id="g13">13. Аннотация типов в коде</h3>
...
***
<h3 id="g15">15. Элементы CI/CD с использованием функционала github</h3>
