...
Замечания от flake8 были устранены введением исключений E203 и E501 (для чего создан конфигурационный файл .flake8 и внесены правки в файле настроек VSCode):
